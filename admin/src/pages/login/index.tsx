...
const Login = () => {
  ...
  return (
    <div className="bg-primary light:bg-[rgb(238,242,246)] bg-[rgb(238,242,246)] flex justify-center items-center h-[100vh]">
      <div
        className='flex-[2.5] dark:bg-[rgb(33,41,70)] bg-white h-[100vh] relative <lg:hidden'
        style={{
      ...
      <div className='flex-[1.7] flex justify-center'>
        <div className='dark:bg-[rgb(33,41,70)] w-[400px] px-[32px] py-[20px] mt-[-12%] bg-white rounded-lg <lg:(w-[94%] mx-auto)'>
          <div className='text-center'>
            <div className='flex justify-center gap-2'>
              ...
              <h1 className='dark:(text-white) ' style={{ marginBottom: '0.2em' }}>墨遥的后台管理</h1>
            </div>
            <h3
